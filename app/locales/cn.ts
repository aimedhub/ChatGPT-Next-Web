...
const cn = {
  ...
  Error: {
    Unauthorized: isApp
      ...
      : `😆 对话遇到了一些问题，不用慌:
       \ 1️⃣ 想要零配置开箱即用，[点击这里立刻开启对话 🚀](${SAAS_CHAT_UTM_URL})
       \ 2️⃣ 如果你正在使用知更鸟网络（微信联系：sub-chatgpt），点击[这里](/#/auth)输入访问秘钥 🔑
  ...
  Auth: {
    ...
    TopTips:
      "🥳 知更鸟网络，立刻解锁 OpenAI o1, GPT-4o, Claude-3.5 等最新大模型",
  },
  ChatItem: {
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        ...
        Label: "（性价比最高的方案）",
        SubTitle:
          "由 知更鸟网络维护, 零配置开箱即用，支持 OpenAI o1, GPT-4o, Claude-3.5 等最新大模型",
        ChatNow: "立刻对话",
      },
      AccessCode: {
        Title: "访问密码",
